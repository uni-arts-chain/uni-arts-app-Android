...
//        val action = PinCodeAction.Check(NavComponentDelayedNavigation(R.id.action_pin_to_main), ToolbarConfiguration())
//        val bundle = PincodeFragment.getPinCodeBundle(action)
...
//        openMain()
    ...
    override fun openAfterPinCode(delayedNavigation: DelayedNavigation) {
        ...
        val navOptions = NavOptions.Builder()
                ...
                .build()
//        if (delayedNavigation.globalActionId == R.id.action_open_main) {
...
//        } else
    ...
    override fun openWalletEdit(address: String) {
        val extras = EditWalletFragment.getBundle(address)
        navController?.navigate(R.id.action_open_edit, extras)
    }

    override fun openSeed(address: String) {
        openAfterPinCode(openExportSeed(address))
    }
    ...
    override fun openExportKeyStore(json: String) {
        val bundle = Bundle();
        bundle.putString("json", json)
        ARouter.getInstance().build(ArouterModelPath.QC_CODE_ACTIVITY).with(bundle).navigation()
    }

    override fun openExportJson(accountAddress: String): DelayedNavigation {
        val extras = ExportJsonPasswordFragment.getBundle(accountAddress)
        return NavComponentDelayedNavigation(R.id.action_mainFragment_to_json, extras)
    }
