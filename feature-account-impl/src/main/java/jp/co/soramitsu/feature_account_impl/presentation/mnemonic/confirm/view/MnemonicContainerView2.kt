...
class MnemonicContainerView2 @JvmOverloads constructor(
    context: Context,
    ...
    init {
        View.inflate(context, R.layout.view_mnemonic_container2, this)
        setBackgroundResource(R.drawable.bg_mnemonic_container_gray)
