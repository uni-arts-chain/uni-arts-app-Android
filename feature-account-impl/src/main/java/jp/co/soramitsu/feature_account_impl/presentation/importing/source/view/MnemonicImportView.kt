...
class MnemonicImportView @JvmOverloads constructor(
    ...
    init {
        importMnemonicContentContainer.background = context.getDrawable(R.drawable.mnemonic_backup_alert_dialog_bg)

        importMnemonicUsernameInput.text.filters = nameInputFilters()
    }

    override fun observeCommon(viewModel: ImportAccountViewModel, lifecycleOwner: LifecycleOwner) {
        importMnemonicUsernameInput.bindTo(viewModel.nameLiveData, lifecycleOwner)
    }
