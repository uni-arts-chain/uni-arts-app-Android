...
import jp.co.soramitsu.fearless_utils.encrypt.json.*
...
//        val address = keypair.publicKey.toAddress(addressByte)
        val address = sS58Encoder.encode(keypair.publicKey, 42)
        val importData = JsonAccountData(
                ...
                meta = JsonAccountData.Meta(
                        name = name,
                        whenCreated = System.currentTimeMillis() / 1000,
