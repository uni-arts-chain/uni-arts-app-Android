...
import kotlinx.android.synthetic.main.fragment_export_json_password.*
...
class ExportJsonPasswordFragment : BaseFragment<ExportJsonPasswordViewModel>() {
    ...
    override fun initViews() {
        ...
        sellAction.setOnClickListener { viewModel.nextClicked() }

        exportJsonPasswordMatchingError.setDrawableStart(R.drawable.ic_red_cross, 24)
//        exportJsonPasswordNext.performClick()
    }
    ...
    override fun subscribe(viewModel: ExportJsonPasswordViewModel) {
        exportJsonPasswordNewField.bindTo(viewModel.passwordLiveData)
        exportJsonPasswordConfirmField.bindTo(viewModel.passwordConfirmationLiveData)
